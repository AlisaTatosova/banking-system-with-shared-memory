...
void transfer(int account_num1, int account_num2, int amount, Account* accounts) {
	...
	if (accounts[account_num2 + 1].get_balance() + amount <= accounts[account_num2 + 1].get_max_balance()) {
            ...
            std::cout << "Transfer of " << amount << " from account " << account_num << " to account " << account_num2 << " successful.\n";
	}
	...
	std::cout << "Transfer of " << amount << " from account " << account_num1 << " to account " << account_num2 << " is unsuccessful, account has 
			not enough money.\n";
